...
export const routes: Routes = [
  ...
  { path: 'auth', component: AuthComponent },
  {
    ...
    children: [
      { path: '', component: BasicControlComponent, title: 'Basic Server Control' },
      ...
      { path: 'host', component: HostComponent, title: 'Host' },
      {
        ...
        data: { title: 'Backups', text: 'Backup creation and restore are the next MVP slice.' },
      },
      {
        path: 'settings',
        component: ComingSoonComponent,
        data: {
          title: 'Settings',
          text: 'Host paths and runtimes are currently configured through appsettings or environment variables.',
        },
      },
    ],
  },
